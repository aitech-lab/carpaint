...
var L, animate, c_camera, camera, car, carpaint_mat, controls, create_evironment, environment, init, lights, material, mesh, onWindowResize, render, renderer, rnd, scene, setupControls, shader_loader, sky, sphere_mesh, stats;
...
create_evironment = function() {
  ...
  materials = (function() {
    ...
    results = [];
    for (i = j = 1; j <= 4; i = ++j) {
      results.push(new THREE.MeshBasicMaterial({
        color: 0xffffff,
